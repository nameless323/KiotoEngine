...
public:
    ...
    void ParseMesh(Mesh* dst) override;
...
private:
    ...
    void TraverseHiererchy(FbxScene* scene, Mesh* dst);
    void TraverseHiererchy(FbxNode* node, int32 depth, Mesh* dst);
    void ParseFbxMesh(FbxNode* node, Mesh* dst);
